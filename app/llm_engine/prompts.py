...
def user_prompt(chart: dict, interpretation: dict) -> str:
    return (
        ...
        "- The application will render your answer inside an Interpretation tab beside a separate Charts & Positions tab. Therefore, write predictive interpretation only; do not dump raw planet tables.\n"
        "- Start with an immediately usable Quick Verdict style opening: 1-2 sentences that answer the question directly before detailed reasoning.\n"
        "- Keep the core analysis easy to convert into bullets: Lagna/Lagna lord, Moon/query state, relevant question house, and Dasha timing must be clearly identifiable in the prose.\n"
